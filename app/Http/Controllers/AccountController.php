...
class AccountController extends Controller
{
    ...
    public function myJobApplications()
    {
        $jobApplications = JobApplication::where('user_id', Auth::user()->id)
            ->with('boardJob', 'boardJob.jobType', 'boardJob.applications')->orderBy('created_at','DESC')->paginate(10);
    ...
    public function savedJobs(){
        ...
        $savedJobs=SavedJob::where(['user_id'=>Auth::user()->id])->with('boardJob','boardJob.jobType','boardJob.applications')
    ...
    {
        $savedJob = SavedJob::where(['id' => $request->id, 'user_id' => Auth::id()])->first();
